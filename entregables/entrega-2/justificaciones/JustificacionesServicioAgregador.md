...
Tuvimos problemas al conectarnos con las fuenteColeccions en el service de Colecciones.
...
agregar varias fuenteColeccions de un mismo tipo.
...
datos los hechos ya que los ids se pueden repetir entre las fuenteColeccions. También tomamos la decisión
de colocarle a su vez el id a la fuenteColeccion, para facilitar la búsqueda de la conexión que
